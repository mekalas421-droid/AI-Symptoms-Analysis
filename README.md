...
|---|---|---|
| Web Application (Frontend) | http://18.61.211.177/ | ✅ HTTP 200 OK |
| API Health Check | http://18.61.211.177/health | ✅ Healthy |
| Interactive API Documentation | http://18.61.211.177/api/docs | ✅ HTTP 200 OK |
| Symptoms API | http://18.61.211.177/api/v1/symptoms | ✅ 190 Symptoms Live |